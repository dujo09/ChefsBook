...
public class RecipeCategoryRepository {
    ...
    public void getRecipeCategories(MutableLiveData<List<RecipeCategory>> liveList, MutableLiveData<String> error) {
        recipeCategoryCollection.addSnapshotListener((snapshots, e) -> {
            if (e != null) {
