              ...
              db.runTransaction(
                          ...
                          transaction -> {
                            ...
                            if (snap.exists()) {
                              throw new FirebaseFirestoreException(
                                  "Username taken", FirebaseFirestoreException.Code.ABORTED);
                            }
                  ...
                  .addOnSuccessListener(
                      aVoid -> {
                        ...
                        startActivity(
                            new Intent(RegisterActivity.this, RecipeCategoryListActivity.class));
                        finish();
                      })
                                ...
                                .addOnCompleteListener(
                                    delTask -> {
                                      if (delTask.isSuccessful()) {
                                        ...
                                        Log.e(
                                            TAG,
                                            "Failed to delete orphan auth user",
                                            delTask.getException());
                                      }
                                    });
                          }
                        } else {
